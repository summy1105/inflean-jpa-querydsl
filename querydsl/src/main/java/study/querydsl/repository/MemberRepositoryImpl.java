...
// 이름에 규칙이 있음 -> spring jpa의 repository이름에 Impl추가해야함
...
//        return new PageImpl<>(content, pageable, total);
        return PageableExecutionUtils.getPage(content, pageable, countQuery::fetchCount); // page상황에 따라, countQuery 실행여부를 결정함
    }
